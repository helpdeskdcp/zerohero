...
def decide_from_context(bars_by_tf: dict, chain: list | None, *,
    ...
    ctx = {
        ...
        "vwap_status": sr.get("vwap_status"), "vwap_reason": sr.get("vwap_reason"),
        ...
        "gex_flip": sr.get("gex_flip"), "gex_pin": sr.get("gex_pin"),
        "gex_regime_sign": sr.get("gex_regime_sign"), "gex_sigma": sr.get("gex_sigma"),
        "sr_diag": sr.get("sr_diag"),          # read-only S/R + OI-wall + VWAP + GEX trace
    ...
    return {
        ...
        "atr": sr.get("atr"), "vwap": sr.get("vwap"),
        "momentum": st.get("roc_pct"), "state_score": st.get("state_score"),
